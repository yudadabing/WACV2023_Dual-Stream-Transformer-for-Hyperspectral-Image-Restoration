...
class DSAttention(nn.Module):
    r""" Window based Multi-head Spatial Self-Attention (MSSA) module  and Multi-head Spatial Self-Attention (MSSA).
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        ## Multi-head Spatial Self-Attention (MSSA)
        ...
        self.proj_drop = nn.Dropout(proj_drop)
          ...
          ##Multi-Dconv-head Spectral Attention (MDSA  )
...
class  DualStreamBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.mlp = DSFN(dim,mlp_hidden_dim,bias=False)   
...
class DSTB(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            DualStreamBlock(dim=dim, input_resolution=input_resolution,
...
class DSTG(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.residual_group = DSTB(dim=dim,
